...
urlpatterns = [
	...
	# Timer Delete
	url(
		r'^timer/(?P<timer_id>[0-9]+)/delete/$', views.timer_del, 
		name='timer_del'),
	# Timer Reset
	url(
		r'^timer/(?P<timer_id>[0-9]+)/reset/$', views.timer_reset, 
		name='timer_reset'),
	# Timer Share
	url(
		r'^timer/(?P<timer_id>[0-9]+)/share/$', views.timer_share, 
		name='timer_share'),
	# Timer Unshare	
	url(
		r'^timer/(?P<timer_id>[0-9]+)/unshare/$', views.timer_unshare, 
		name='timer_unshare'),
	# Timer Rename	
	url(
	...
	# Timer Suspend / Stop
	url(
		r'^timer/(?P<timer_id>[0-9]+)/stop/$', views.timer_stop, 
		name='timer_stop'),
	# Add Timer to Group
	url(
		r'^timer/(?P<timer_id>[0-9]+)/add_to_group/$', 
	...
	url(
		r'^sign_in/quicklist/$', views.session_quicklist, 
	...
	url(
		r'^sign_up/quicklist/$', views.quicklist_new, 
	...
	url(
		r'^timers/group/new/$', views.settings_new_timer_group, 
		name='settings_new_timer_group'),
	# User Settings: delete Timer Group
	url(
		r'^timers/group/delete$', views.settings_delete_timer_group, 
		name='settings_delete_timer_group'),
	# User Settings Password Change
	url(
		r'^setup/password$', views.settings_set_password, 
